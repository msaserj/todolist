...
export const setIsLoggedIn = createAction<{ value: boolean }>('auth/isLoggedIn')

export const changeTodolistFilter = createAction<{ todolistId: string, filter: string }>('todolist/filter')
